export default function InitialMessage() {
  return (
    <div className="border-[3px] border-[#666666] bg-[#1E1E1E] p-6 md:p-10 text-center">
      ...
      <h2 className="text-xl md:text-2xl font-bold uppercase mb-3">ENTER LOCATION TO START</h2>
      <p className="opacity-70 text-sm md:text-base">GET WEATHER DATA AND OUTFIT RECOMMENDATIONS</p>
    </div>
  );
}
